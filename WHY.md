...
Meanwhile, the Rust ecosystem offers blazing fast parsers (`rio`, `oxigraph`) and template engines (`rinja`, `askama`), but lacks a dedicated, opinionated documentation generator for OWL/RDF.
...
- **Blazing Fast**: Generates complex sites in milliseconds.
...
We want to make documenting an ontology as easy as documenting a Rust crate.
