...
- Six new unit tests: `circular_is_a_chain_resolves_each_class_once`, `circular_mixin_chain_resolves_each_class_once`, `diamond_inheritance_is_not_treated_as_cycle`, `any_of_branch_without_range_inherits_outer_range`, `trait_class_without_descendants_omits_kind_enum_and_falls_back_to_string`, `render_class_emits_warning_comment_for_unresolved_global_slot_ref`.
